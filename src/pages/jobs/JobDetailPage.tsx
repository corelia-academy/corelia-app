...
export default function JobDetailPage() {
  ...
  const structuredData = {
    ...
    "@type": "JobPosting",
    title: job.title,
    description: job.description_plain ?? job.summary ?? "",
    ...
    <div className="mx-auto w-full max-w-6xl px-4 py-6 sm:px-6 lg:px-8">
      ...
      <div className="mt-5 grid gap-5 lg:grid-cols-[minmax(0,1fr)_320px]">
        <main className="space-y-5">
          ...
          <Card><CardContent className="p-6 sm:p-8"><h2 className="text-lg font-semibold">{t("detail.about")}</h2><div className="mt-4 whitespace-pre-wrap text-sm leading-7 text-foreground-muted">{job.description_plain || job.summary || t("detail.noDescription")}</div></CardContent></Card>
