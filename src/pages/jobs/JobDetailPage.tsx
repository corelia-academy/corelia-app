...
export default function JobDetailPage() {
  ...
  if (!jobQuery.data) return <div className="mx-auto max-w-3xl p-8 text-center"><h1 className="text-xl font-semibold">{t("detail.notFound")}</h1><Button render={<Link to="/jobs" />} variant="outline" className="mt-4">{t("detail.back")}</Button></div>;
