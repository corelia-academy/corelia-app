  ...
  return <div className="container-app py-6 sm:py-8">
    ...
    <div className="mt-6 grid items-start gap-8 lg:grid-cols-[minmax(0,1fr)_300px]">
      ...
      <aside className="space-y-5 lg:sticky lg:top-24">
        <section className="rounded-2xl border border-border-subtle bg-surface-base p-5"><p className="text-xs text-foreground-muted">{t("projects.editor.teamLeader")}</p>{ownerLink ? <NavLink className="mt-2 block font-semibold hover:text-primary" to={ownerLink}>{owner.label || owner.handle}</NavLink> : <p className="mt-2 font-semibold">{owner.label}</p>}
