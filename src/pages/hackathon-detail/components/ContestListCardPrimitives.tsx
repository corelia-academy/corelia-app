...
export function ContestListCardDateRowCatalog({
  ...
  return (
    <div className="flex min-h-11 items-center gap-2 rounded-2xl border border-border-subtle bg-surface-base shadow-card px-3 py-2">
...
export function ContestListCardDateRowInstructor({
  ...
  return (
    <div className="rounded-2xl border border-border-subtle bg-surface-base shadow-card px-3 py-2">
      {children}
    </div>
  );
}
