    ...
    <Card className="overflow-hidden">
      ...
      <CardContent className="p-4">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div className="min-w-0">
            ...
            {!isManageView && publicHeroHighlights.length > 0 ? (
              <ul className="mt-4 flex flex-col gap-2 text-sm text-muted-foreground sm:flex-row sm:flex-wrap sm:gap-x-6">
            ...
            {!isManageView && contest.prize_pool_summary?.trim() ? (
              <div className="mt-4 inline-flex max-w-full flex-wrap items-center gap-2 rounded-md border border-border-subtle bg-muted/30 px-3 py-2 text-sm text-foreground">
        ...
        {!isManageView && publicCta && !hideHeroPublicCta ? (
          <div className="mt-5 rounded-md border border-border-subtle bg-muted/25 p-4">
        ...
        <div className="mt-4 flex flex-wrap items-start gap-x-6 gap-y-4 rounded-md border border-border-subtle bg-background p-4 text-sm">
