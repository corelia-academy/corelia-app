...
export function applyHackathonLocaleContent(contest: Contest, localized: ContestI18nContent | null): Contest {
  ...
  return {
    ...
    tagline: localized.short_description ?? localized.tagline ?? contest.tagline,
    short_description: localized.short_description ?? localized.tagline ?? contest.short_description ?? contest.tagline,
    description: localized.description_markdown ?? localized.description ?? contest.description,
    description_markdown: localized.description_markdown ?? localized.description ?? contest.description_markdown ?? contest.description,
