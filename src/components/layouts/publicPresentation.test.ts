...
describe("public presentation boundary", () => {
  it.each(["/learn/course/lesson/lesson", "/feed", "/account/settings", "/achievements", "/jobs/saved", "/jobs/applied", "/jobs/hidden", "/projects/new", "/projects/demo/edit", "/admin/hackathons", "/instructor/courses"])('preserves private appearance for %s', path => {
