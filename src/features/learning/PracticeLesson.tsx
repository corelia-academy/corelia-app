...
function Practice({ lesson, mode, courseId, userId, onAction, onComplete, contentLocale, draftEpoch = 0 }: LessonRendererProps & { userId?: string }) {
  ...
  return <div className="space-y-5">
    ...
    {mode === "learner" && config.mode === "guided_project" && <div className="space-y-2 text-sm"><p>{t("learning.portfolioOptional")}</p><a href="/account/profile" className="text-primary underline">{t("learning.openProfile")}</a></div>}
