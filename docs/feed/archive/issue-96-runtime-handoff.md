> Tài liệu lịch sử issue #96; không xác nhận build hiện tại. Đối chiếu [QA legacy](legacy-qa.md); định hướng mới nằm ở [kế hoạch thay thế](../README.md#migration).
...
`docs/feed/archive/issue-96-manual.html`
