...
- Trên desktop, cột bên phải có mục **Bạn đang theo dõi**: tối đa 6 hồ sơ công khai mà chính người xem đang follow, gồm ảnh, tên, link mở hồ sơ và nút **Xem tất cả** để mở danh sách đầy đủ có tải thêm. Danh sách sắp theo lần follow gần nhất, chỉ gồm người; course/hackathon/project vẫn dùng cho tab Đang theo dõi nhưng không trộn vào mục này. Khi chưa follow hồ sơ công khai nào, cột này gợi ý tối đa 4 hồ sơ công khai khác theo vị trí ngẫu nhiên, kèm nút Follow; không gợi ý chính người xem hoặc hồ sơ private.
...
- Mỗi mục feed là một hàng gọn: **avatar → tên và câu thành tựu có link ngay trong câu → “x giờ trước” → tim**. Không lặp lại avatar/tên ở chân card, không đặt nhãn loại mốc hay icon lớn riêng. Thời gian cập nhật tương đối khi trang đang mở; hover/focus vào thời gian cho biết ngày giờ đầy đủ. Card XP dẫn về hồ sơ; card khóa học dẫn đến course; card submission chỉ dẫn đến hackathon. Không lộ số XP chi tiết ngoài ngưỡng được chia sẻ.
...
- Cột phải hiện đúng người mình follow, thứ tự mới nhất và link hồ sơ; thêm/bỏ follow cập nhật danh sách. Khi danh sách trống, chỉ gợi ý hồ sơ công khai khác và nút Follow hoạt động ngay tại chỗ. Thử riêng tài khoản có hồ sơ private và staff để chắc chắn danh sách vẫn thuộc người đăng nhập. Mobile hiển thị khối thu gọn sau card.
