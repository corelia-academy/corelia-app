...
DECLARE affected int; BEGIN
 ...
 EXCEPTION WHEN check_violation THEN NULL; END;
 UPDATE public.profiles SET role='admin',tier='pro' WHERE id='a7900000-0000-4000-8000-000000000001';
...
INSERT INTO public.profiles(id,role,tier) VALUES ('a7900000-0000-4000-8000-000000000002','admin','pro');
BEGIN
 IF (SELECT role <> 'student' OR tier <> 'free' FROM public.profiles WHERE id='a7900000-0000-4000-8000-000000000002') THEN RAISE EXCEPTION 'Insert escalation allowed'; END IF;
END;
RESET ROLE;
BEGIN
