...
test("Production translation release accepts later released migrations and only permits the missing pair", () => {
  ...
  assert.deepEqual(CURRENT_PENDING_VERSIONS, ["20260915052442", "20260915054142"]);
