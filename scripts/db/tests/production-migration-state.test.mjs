...
test("Production Email Center release accepts the released chain and only permits the Email Center migration", () => {
  ...
  assert.deepEqual(CURRENT_PENDING_VERSIONS, ["20260916093549"]);
