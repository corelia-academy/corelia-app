...
test("Production Learning redo release accepts the current ledger and rejects missing prior migrations", () => {
  ...
  assert.deepEqual(CURRENT_PENDING_VERSIONS, ["20260915062707", "20260915130736"]);
