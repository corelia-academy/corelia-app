...
test("Production avatar release accepts the released chain and only permits the avatar seed migration", () => {
  ...
  assert.deepEqual(CURRENT_PENDING_VERSIONS, ["20260916045248"]);
