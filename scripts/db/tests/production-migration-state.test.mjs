...
test("Production contact sync release accepts the released chain and only permits its migration", () => {
  ...
  assert.deepEqual(CURRENT_PENDING_VERSIONS, ["20260916120421"]);
