...
export const APPROVED_PENDING_MIGRATION_PATHS = Object.freeze([
  ...
  "supabase/migrations/20260910040432_learning_api_scope.sql",
  ...
  "supabase/migrations/20260911142402_learning_practice_project_link.sql",
  "supabase/migrations/20260911152152_learning_section_question_transaction.sql",
  "supabase/migrations/20260911162146_learning_audit_data_boundaries.sql",
  "supabase/migrations/20260911165011_learning_audit_question_boundary.sql",
  ...
  "supabase/migrations/20260911173523_learning_mutation_policy_scope.sql",
  "supabase/migrations/20260911180616_learning_course_creation_scope.sql",
  "supabase/migrations/20260911184027_learning_audit_resource_urls.sql",
  "supabase/migrations/20260911185307_learning_atomic_course_info.sql",
  "supabase/migrations/20260911185926_learning_learning_quiz_submitter.sql",
  "supabase/migrations/20260911194806_learning_api_revision.sql",
  "supabase/migrations/20260911215843_submit_quiz_attempts_invoker_wrapper.sql",
  "supabase/migrations/20260912101500_learning_course_publish_audit.sql",
]);
