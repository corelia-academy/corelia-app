...
export const EMAIL_CLASS_STYLES: Record<string, string> = {
  "e-header": `padding:12px 24px;background-color:${b.background};border-bottom:1px solid ${b.border};`,
  ...
  "e-footer": `padding:16px 24px;background-color:${b.background};font-size:12px;color:${b.muted};line-height:18px;text-align:left;`,
  "e-footer-item": `margin:0 0 4px;line-height:18px;color:${b.muted};`,
  "e-footer-item-last": `margin:0;line-height:18px;color:${b.muted};`,
  "e-info-card": `padding:20px 24px;background-color:${b.surface};border-top:1px solid ${b.border};border-bottom:1px solid ${b.border};`,
  ...
  "e-otp": `padding:24px;background-color:${b.surface};border-top:1px solid ${b.border};border-bottom:1px solid ${b.border};text-align:center;`,
  ...
  "e-alert": `padding:24px;background-color:${b.background};border-bottom:1px solid ${b.border};`,
