-- E-3 fix: private profiles must not be discoverable via search at all, not
-- just have their bio/website scrubbed. 20260714000000 deliberately allowed
-- private profiles to still surface (by name/username/ocid); this reverses
-- that specific decision per product requirement — a private profile should
-- be fully hidden from search results, matching the original spec.
